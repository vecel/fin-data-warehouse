...
WITH news AS (
    SELECT
        ...
        news_secondary_topic_name,
        news_secondary_topic_relevance_value,
        news_tertiary_topic_name,
...
market_news_fact AS (
    SELECT
        ...
        n.news_secondary_topic_name::VARCHAR(50),
        n.news_secondary_topic_relevance_value::DOUBLE PRECISION,
        n.news_tertiary_topic_name::VARCHAR(50),
        n.news_tertiary_topic_relevance_value::DOUBLE PRECISION,
