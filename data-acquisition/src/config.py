...
class Config:
    ...
    CALENDARS_CACHE_FILE = f'{CACHE_DIRECTORY}/trading_calendars'
    CALENDARS_STAGING_FILE = f'{STAGING_DIRECTORY}/trading_calendars'
    CALENDARS_CACHE_DAYS_VALID = 365
    CALENDARS_END_DATE = '2026-12-31'

    NASDAQ_TICKERS_CACHE_FILE = f'{CACHE_DIRECTORY}/nasdaq_tickers'
    NYSE_TICKERS_CACHE_FILE = f'{CACHE_DIRECTORY}/nyse_tickers'
    WSE_TICKERS_CACHE_FILE = f'{CACHE_DIRECTORY}/wse_tickers'
    TICKERS_CACHE_DAYS_VALID = 365

    WSE_INFO_CACHE_FILE = f'{CACHE_DIRECTORY}/wse_tickers_info'
